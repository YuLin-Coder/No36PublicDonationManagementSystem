...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/biz/bizProductionPlan/">生产计划列表</a></li>
		<shiro:hasPermission name="biz:bizProductionPlan:edit"><li><a href="${ctx}/biz/bizProductionPlan/form?auditFlag=0">生产计划添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="bizProductionPlan" action="${ctx}/biz/bizProductionPlan/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="bizProductionPlan">
			<tr>
				...
				<td>
					<fmt:formatDate value="${bizProductionPlan.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<shiro:hasPermission name="biz:bizProductionPlan:edit"><td>
    				<a href="${ctx}/biz/bizProductionPlan/form?id=${bizProductionPlan.id}&auditFlag=0">修改</a>
