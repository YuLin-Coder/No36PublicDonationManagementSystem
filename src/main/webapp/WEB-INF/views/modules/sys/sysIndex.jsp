...
<head>
	...
	<style type="text/css">
		...
		#header .brand {font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:16px;padding-left:33px;}
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><span><img src="${ctxStatic}/images/logo.png"  width="30" height="32" >&nbsp;&nbsp;${fns:getConfig('productName')}</span></div>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2017-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="#" target="_blank">ITG</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
